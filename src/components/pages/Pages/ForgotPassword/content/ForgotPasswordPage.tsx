		...
		<div className='bg-darkBlue min-h-screen h-full w-full flex flex-col md:flex-row '>
			...
			<div className='basis-1/3 bg-mediumBlue flex flex-col justify-center items-center p-10'>
				<div className='px-4 space-y-4 w-full'>
					...
					<h2 className='text-xl text-gray-400 font-thin'>Enter your email and we'll send you instructions to reset your password</h2>
					<div>
						<InputWithLabel label='Email' id='forgotPassword' type='text' value={email} onChange={e => setEmail(e.target.value)} />
