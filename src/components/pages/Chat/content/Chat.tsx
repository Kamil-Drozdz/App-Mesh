  ...
  return (
    <CardContainer className='flex space-y-0 p-0 '>
      <div
        ...
        } ease absolute z-[1] h-full w-full rounded-r-lg rounded-l-lg border-r-[1px] bg-white p-6 text-gray-900 transition-transform duration-300  dark:bg-mediumBlue dark:text-white md:relative md:h-auto md:w-1/4 md:min-w-[300px] md:translate-x-0 md:rounded-r-none`}
      >
                ...
                {filteredChats.map((chat) => (
                  <>
                    <div
                      ...
                      } dark:hover:bg-darkBluee cursor-pointer hover:bg-gray-100`}
                    >
      ...
      <div className='w-full bg-white p-6 text-gray-900 dark:bg-mediumBlue dark:text-white  md:w-3/4 '>
        <div className=' rounded-t-lg border-b-[1px] border-b-gray-600 bg-lightBlue p-4 text-white md:rounded-t-none md:rounded-tr-lg'>
