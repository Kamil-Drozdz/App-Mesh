				...
				<div key={i} role='status' className='animate-pulse m-4 p-2 bg-stone-900 rounded-lg flex justify-start items-start gap-2 flex-wrap'>
					<div className='flex items-center w-full'>
						<div className='flex items-center justify-center w-full p-2 bg-gray-300 rounded dark:bg-gray-700'>
							<svg className='w-full aspect-video text-gray-200 dark:text-gray-600' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 18'>
