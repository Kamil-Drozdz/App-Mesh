		...
		<div className='bg-darkBlue min-h-screen h-full w-full flex flex-col md:flex-row '>
			...
			<div className='basis-1/3 bg-mediumBlue flex flex-col justify-center items-center p-10'>
				<div className='px-4 space-y-4 w-full'>
					...
					<div>
						<InputWithLabel label='Username' id='displayName' type='text' value={formData.displayName} onChange={e => setFormData({ ...formData, displayName: e.target.value })} />
					...
					<div className='w-full flex justify-between items-center'>
						<div className='flex flex-col  items-center'>
							<div className='flex space-x-2 items-center'>
								<Input id='terms' className={`w-4 h-4 `} defaultChecked={false} type='checkbox' checked={formData.terms} onChange={() => setFormData({ ...formData, terms: !formData.terms })} />
								<label htmlFor='terms'>
									I agree to
