...
const CardProject = () => {
	...
	return (
		<CardContainer className='basis-1/3 space-y-3 flex flex-col justify-between'>
			...
			<h2 className='dark:text-gray-300 text-2xl'>App design</h2>
			<span className='font-thin text-sm text-gray-400'>You can Find Only Post and Quotes Related to IOS like ipad app design, iphone app design</span>
