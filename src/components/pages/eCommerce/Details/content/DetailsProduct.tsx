		...
		<>
			...
			<div className='flex py-16'>
				<div className='flex flex-col w-full text-center space-y-3'>
					...
					<span className='text-sm text-gray-400'>Chocolate bar candy canes ice cream toffee. Croissant pie cookie halvah.</span>
				</div>
				<div className='flex flex-col w-full text-center space-y-3'>
					<BiTimeFive size={IconSize.medium} className='w-full text-violet-500' />
					<p className='text-2xl font-semibold'>10 Day Replacement</p>
					<span className='text-sm text-gray-400'>Marshmallow biscuit donut dragée fruitcake. Jujubes wafer cupcake.</span>
				</div>
				<div className='flex flex-col w-full text-center space-y-3'>
					<BsShield size={IconSize.medium} className='w-full text-violet-500' />
					<p className='text-2xl font-semibold'>1 Year Warranty</p>
					<span className='text-sm text-gray-400'>Cotton candy gingerbread cake I love sugar plum I love sweet croissant.</span>
				</div>
			</div>
		</>
	);
